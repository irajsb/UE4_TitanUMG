...
#include "STitanProgressBar.generated.h"
...
UENUM(BlueprintType)
namespace ETitanProgressBarFillType
{
	enum Type
	{
...
class TITANUMG_API STitanProgressBar : public SLeafWidget
{

public:
	SLATE_BEGIN_ARGS(STitanProgressBar)
		: _Style( &FCoreStyle::Get().GetWidgetStyle<FProgressBarStyle>("ProgressBar") )
		, _BarFillType(ETitanProgressBarFillType::LeftToRight)
		...
		SLATE_ARGUMENT( ETitanProgressBarFillType::Type, BarFillType )
	...
	void SetBarFillType(ETitanProgressBarFillType::Type InBarFillType);
	...
	void  SetIndicatorImage( FSlateBrush* InBackgroundImage);
	...
	//num of updates to ignore
	int FreezeLagAfterUpdate;
	int CurrentFreezeLagAfterUpdate;
	float LerpSpeed;
private:
...
private:
	...
	ETitanProgressBarFillType::Type BarFillType;
